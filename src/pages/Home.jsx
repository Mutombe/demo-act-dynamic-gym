      ...
      <div className="relative z-20 grid lg:grid-cols-2 min-h-screen">
        ...
        <motion.div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-32 lg:py-20" style={{ y: textY, opacity }}>
          ...
          <div className="overflow-hidden">
            {(hero.titleLines || ['UNLEASH', 'POTENTIAL']).map((line, i) => (
        ...
        <div className="relative hidden lg:block">
          <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=1200&q=80" alt="Act Dynamic Gym" className="absolute inset-0 w-full h-full object-cover object-center" loading="eager" />
...
function JourneySection() {
  ...
  const inView = useInView(ref, { once: true, margin: '-80px' });
  const steps = [
    { num: '01', title: 'Consultation', desc: 'Sit down with a certified trainer to map out your fitness roadmap.' },
    { num: '02', title: 'Program Design', desc: 'Tailored workout splits, nutrition guidance, and recovery protocols.' },
    { num: '03', title: 'Execute', desc: 'Show up, put in the work, and trust the process every single day.' },
    { num: '04', title: 'Results', desc: 'Watch your body and mind transform as consistency meets expertise.' },
  ];
  return (
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1200&q=80" alt="Act Dynamic Gym" className="w-full aspect-[4/5] object-cover object-center" loading="eager" />
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              {about?.description || "Act Dynamic Gym was founded on a simple belief: that everyone deserves access to world-class fitness. Located in Harare, we combine cutting-edge equipment with passionate coaching to help you become the strongest version of yourself."}
            </p>
            <div className="grid grid-cols-3 gap-6 mt-10 border-t border-white/5 pt-8">
              ...
              <div><div className="text-[#EF4444] font-heading text-3xl font-bold italic">{business.rating || 4.9}</div>
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src="https://images.unsplash.com/photo-1576678927484-cc907957088c?w=1200&q=80" alt="Act Dynamic Gym" className="w-full h-[130%] object-cover object-center" loading="eager" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href={`https://wa.me/${business.whatsappNumber || '263772692247'}?text=${encodeURIComponent(homeCta?.whatsappText || "Hi! I'd like to join Act Dynamic Gym.")}`}
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8 }}>
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div><p className="text-white text-sm font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>{business.address || 'Clyde Shop, Clyde Rd, Harare, Zimbabwe'}</p></div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div><a href={`tel:${business.phone || '+263 77 269 2247'}`} className="text-white/60 text-sm hover:text-[#EF4444] transition-colors" style={{ fontFamily: 'var(--font-sans)' }}>{business.phone || '+263 77 269 2247'}</a></div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div><a href={`https://wa.me/${business.whatsappNumber || '263772692247'}`} target="_blank" rel="noopener noreferrer" className="text-white/60 text-sm hover:text-[#EF4444] transition-colors" style={{ fontFamily: 'var(--font-sans)' }}>Message on WhatsApp</a></div>
              </div>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 30 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, delay: 0.15 }} className="relative aspect-[4/3] overflow-hidden">
            <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1200&q=80" alt="Act Dynamic Gym" className="w-full h-full object-cover object-center" loading="eager" />
