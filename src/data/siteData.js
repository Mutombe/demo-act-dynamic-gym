...
const siteData = {
  business: {
    name: "Act Dynamic Gym", legalName: "Act Dynamic Gym", tagline: "Where Champions Are Built",
    description: "Where Champions Are Built",
    phone: "+263 77 269 2247", phoneRaw: "+263772692247", whatsappNumber: "263772692247", email: "info@actdynamic.co.zw",
    address: "Clyde Shop, Clyde Rd, Harare, Zimbabwe", country: "Zimbabwe", city: "Harare",
    rating: 4.9, ratingRounded: 5, reviewCount: 18, established: "2018", yearsExperience: "6+", projectsCompleted: "300+", employees: "10+",
    ...
    cookieConsentKey: "act-dynamic-gym-consent",
    socialLinks: { facebook: "#", instagram: "#", linkedin: "#" },
  },
  navbar: { logoImage: null, logoLine1: "Act", logoLine2: "Dynamic Gym" },
  hero: {
    badge: "Harare's Elite Performance Training Centre",
    titleParts: [{ text: "WHERE " }, { text: "CHAMPIONS", highlight: true }, { text: " ARE BUILT." }],
    subtitle: "Where Champions Are Built.",
    ctaPrimary: "Join Now", ctaSecondary: "See Our Facility", trustBadge: "300+ Members",
    backgroundImages: [
      { url: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1920&q=85", alt: "Act Dynamic Gym - professional service" },
      { url: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=1920&q=85", alt: "Act Dynamic Gym - professional service" },
      { url: "https://images.unsplash.com/photo-1540497077202-7c8a3999166f?w=1920&q=85", alt: "Act Dynamic Gym - professional service" }
    ],
  },
  stats: [
    { number: "300+", label: "Active Members" },
    { number: "6+", label: "Years Open" },
  ...
  homeTestimonials: [
    { text: "Outstanding service from Act Dynamic Gym. Professional, thorough, and delivered exactly what was promised. I would not hesitate to recommend them to anyone.", name: "Tendai Moyo", role: "Satisfied Client", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We have been using Act Dynamic Gym for years and the quality has never dropped. Consistent excellence and genuine care for their clients.", name: "Grace Mutasa", role: "Business Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
    { text: "From the initial consultation to final delivery, every step was handled with professionalism. Act Dynamic Gym sets the standard in their industry.", name: "James Karonga", role: "Property Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "The team at Act Dynamic Gym went above and beyond our expectations. Their expertise and attention to detail are truly impressive.", name: "Patricia Sibanda", role: "Corporate Client", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "I have referred Act Dynamic Gym to everyone I know. Their combination of skill, integrity, and fair pricing is unmatched in Harare.", name: "Michael Chigwedere", role: "Repeat Client", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" }
  ],
  reviews: {
    ...
    items: [
      ...
      { text: "Every step handled with professionalism. Act Dynamic Gym sets the standard.", name: "James Karonga", role: "Property Owner", rating: 5 },
  ...
  about: {
    ...
    story: ["Act Dynamic Gym was born in 2018 from a belief that every person has a champion inside them. Our Clyde Road facility is designed for those who train with purpose.", "With a 4.9 Google rating and a tight-knit community of dedicated athletes, we deliver results-driven training in an environment that pushes you to be your best.", "We are committed to delivering results that exceed expectations, every single time."],
    values: [
  ...
  whyChooseUs: { title: "Why Act Dynamic", points: [{ title: "Performance Focus", desc: "Training programs designed for results, not just reps." },{ title: "Small Group Training", desc: "Personalised attention in every session." },{ title: "4.9 Star Rating", desc: "Harare's highest-rated gym experience." },{ title: "Community Driven", desc: "A brotherhood of athletes pushing each other forward." }] },
  ...
  contact: { heroTitle: "Get In Touch", heroSubtitle: "Visit us or reach out for a free consultation.", branches: [
    { name: "Harare Office", address: "Clyde Shop, Clyde Rd, Harare, Zimbabwe", phone: "+263 77 269 2247", email: "info@actdynamic.co.zw" },
  ] },
  homeCta: {
    title: "STOP WAITING. START TRAINING.", subtitle: "Champions are not born -- they are built. Join Harare's most dedicated training community today.",
    ctaPrimary: "Join Now", ctaSecondary: "Chat on WhatsApp",
    whatsappText: "Hello Act Dynamic Gym! I'm interested in joining.",
    backgroundImage: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1920&q=85",
  },
  footer: { description: "Harare's elite performance training centre since 2018.", copyright: "Act Dynamic Gym" },
};
